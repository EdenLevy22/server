...
let virtual-env = "D:\Documents\‏‏מסמכים\לימודים\שנה ג\סמסטר ב\WEB\עבודות בית\server\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Documents\‏‏מסמכים\לימודים\שנה ג\סמסטר ב\WEB\עבודות בית\server\venv\Scripts\deactivate.nu"
